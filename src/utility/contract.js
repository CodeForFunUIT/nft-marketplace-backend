...
const ERC20_ABI_marketPlace = [
  ...
  {
    inputs: [
      { internalType: "uint256", name: "feeDecimal_", type: "uint256" },
...
const addressMarketPlace = process.env.ADDRESS_MERKETPLACE;
const addressNNGToken = process.env.ADDRESS_NNG_TOKEN;
const addressNFT = process.env.ADDRESS_NFT;
...
export const contractNNGToken = new ethers.Contract(
  addressNNGToken,
  ERC20_ABI_NNGToken,
  provider
);
export const contractNFT = new ethers.Contract(
  addressNFT,
  ERC20_ABI_NFT,
  provider
);
